...
node index.js init-near2eth-client --near2eth-client-lock-eth-amount 1e18 --near2eth-client-lock-duration 30
...
--near-receiver-account eth2nearprover --near-master-account eth2nearprover \
