...
contract('TokenLocker', function ([_, addr1]) {
    ...
    it('should be ok', async function () {
        ...
        let lockerBalance = await this.token.balanceOf(this.locker.address);
        console.log(`LOCKER BALANCE ${lockerBalance}`);
        let receiverBalance = await this.token.balanceOf('0xEC8bE1A5630364292E56D01129E8ee8A9578d7D8');
        console.log(`RECEIVER BALANCE ${receiverBalance}`);
        await this.locker.unlockToken(proof1, 1099);
        let balance = await this.token.balanceOf('0xEC8bE1A5630364292E56D01129E8ee8A9578d7D8');
