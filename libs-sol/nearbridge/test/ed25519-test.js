...
const abi = JSON.parse(readFileSync(__dirname + "/../dist/Ed25519.full.abi"));
const code = readFileSync(__dirname + "/../dist/Ed25519.full.bin", "utf8");
const tests = JSON.parse(readFileSync(__dirname + "/ed25519-test-cases.json"));
