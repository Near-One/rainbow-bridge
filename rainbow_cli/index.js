...
const { StartEthRelayCommand } = require('./commands/start/eth-relay');
const { StartNearRelayCommand } = require('./commands/start/near-relay');
const { StartNearWatchdogCommand } = require('./commands/start/near-watchdog');
const { StartGanacheNodeCommand } = require('./commands/start/ganache');
const { StartLocalNearNodeCommand } = require('./commands/start/near');
const { StopLocalNearNodeCommand } = require('./commands/stop/near');
const { StopManagedProcessCommand } = require('./commands/stop/process');
