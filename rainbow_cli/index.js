...
const { StartEthRelayCommand } = require('./commands/start/eth-relay.js.js');
const { StartNearRelayCommand } = require('./commands/start/near-relay.js.js');
const { StartNearWatchdogCommand } = require('./commands/start/near-watchdog.js.js');
const { StartGanacheNodeCommand } = require('./commands/start/ganache.js.js');
const { StartLocalNearNodeCommand } = require('./commands/start/near.js.js');
const { StopLocalNearNodeCommand } = require('./commands/stop/near.js.js');
const { StopManagedProcessCommand } = require('./commands/stop/process.js.js');
