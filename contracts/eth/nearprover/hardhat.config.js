...
task('upgrade-provers-bridge-address-to', 'Upgrades the provided prover to use the bridge at the provided address')
    ...
    .addParam('ledgerKey', 'The ledger key path to sign transactions', undefined, undefined, true)
    .setAction(async taskArgs => {
        const { upgradeProversBridgeAddressTo } = require('./utils/upgrade_bridge_address.js');
        await upgradeProversBridgeAddressTo(hre.ethers.provider, taskArgs.prover, taskArgs.newBridge, taskArgs.ledgerKey);
    });
