...
node index.js transfer-eth-erc20-to-near --token-name myerc20 --amount 1000 \
...
node index.js transfer-eth-erc20-from-near --token-name myerc20 --amount 1 --near-sender-account rainbow_bridge_eth_on_near_prover \
