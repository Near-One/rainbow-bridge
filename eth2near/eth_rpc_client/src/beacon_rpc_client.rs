use crate::errors::{
    ErrorOnJsonParse, ExecutionPayloadError, FailOnGettingJson, NoBlockForSlotError,
};
...
impl BeaconRPCClient {
    ...
    pub fn get_light_client_update(
        ...
        // Read the JSON string into LightClientUpdate
        let light_client_update: LightClientUpdate =
            serde_json::from_str(&light_client_update_json_str)?;
...
mod tests {
    ...
    fn test_fetch_light_client_update() {
        ...
        assert_eq!(
            light_client_update.attested_header.beacon.proposer_index,
        ...
        assert_eq!(
            serde_json::to_string(&light_client_update.attested_header.beacon.parent_root).unwrap(),
            format!(
                "\"{}\"",
        ...
        assert_eq!(
            serde_json::to_string(&light_client_update.attested_header.beacon.state_root).unwrap(),
            format!(
                "\"{}\"",
        ...
        assert_eq!(
            serde_json::to_string(&light_client_update.attested_header.beacon.body_root).unwrap(),
            format!(
                "\"{}\"",
        ...
        let finality_update = light_client_update.finalized_header;
        assert_eq!(
            finality_update.beacon.slot,
        ...
        assert_eq!(
            serde_json::to_string(&finality_update.beacon.body_root).unwrap(),
            format!(
                "{}",
        ...
        assert_eq!(
            serde_json::to_string(&light_client_update.finality_branch).unwrap(),
